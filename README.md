Ming's vimrc
============
* Author: Ming-Ying Chung <itsmings@gmail.com>
...
or wget (for most UNIX platforms):
     ...
     wget -O - https://raw.github.com/mingyc/vimrc/master/auto-install.sh | sh
...
1. Check out from github
        ...
        git clone git://github.com/mingyc/vimrc.git ~/.vim
        cd ~/.vim
...
1. Check out from github
        ...
        git clone git://github.com/mingyc/vimrc.git vimfiles
        cd vimfiles
        git submodule update --init
